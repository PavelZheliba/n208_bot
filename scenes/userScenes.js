...
// ... (остальной код сцены остается без изменений) ...
...
//     }
//
//     // --- ИЗМЕНЕНИЕ ЗДЕСЬ: Возвращаемся к единой, но правильно упорядоченной клавиатуре ---
//     // Первый ряд - навигация (controlButtons), второй ряд - номера (numberButtons)
//     const keyboard = Markup.inlineKeyboard([
//         controlButtons,
//         numberButtons
//     ]);
...
//     await ctx.telegram.deleteMessage(ctx.chat.id, loadingMessage.message_id);
//     await ctx.replyWithMediaGroup(mediaGroup);
//     await ctx.reply('Выберите товар по его номеру:', keyboard); // Отправляем одно сообщение с полной клавиатурой
// }
//
// async function showFullProductCard(ctx, nmID) {
//     // ... (эта функция без изменений)
...
// //     }
// //
// //     const navigationKeyboard = Markup.inlineKeyboard([controlButtons]);
// //     const numbersKeyboard = Markup.inlineKeyboard([numberButtons]);
// //
// //     await ctx.telegram.deleteMessage(ctx.chat.id, loadingMessage.message_id);
// //
// //     await ctx.replyWithMediaGroup(mediaGroup);
// //
// //     // --- ИСПРАВЛЕНИЕ ЗДЕСЬ ---
// //     // Используем обычную точку вместо "невидимого" символа. Это надежно.
// //     await ctx.reply('.', navigationKeyboard);
// //
// //     await ctx.reply('Выберите товар по его номеру:', numbersKeyboard);
// // }
// //
// // async function showFullProductCard(ctx, nmID) {
// //     // ... (эта функция без изменений)
